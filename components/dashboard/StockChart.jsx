...
const StockChart = ({ selectedStock, stockName }) => {
  ...
  return (
    <div className='col-span-12 lg:col-span-8'>
      <h1 className='text-primary text-3xl font-semibold'>Portfolio Summary</h1>
      <div className='flex flex-row justify-between items-end mt-8'>
        <div className='flex flex-row justify-start items-end'>
          <h2 className='text-4xl font-semibold mr-8 text-white'>
            {selectedStock}
          </h2>
          <span className='text-lg text-white'>{stockName}</span>
        </div>
        <button
