...
const StockCard = ({ onSelectCard, stock, selectedStock }) => {
  ...
  return (
    <div
      ...
      data-name={name}
      data-abbr={abbr}
      className={`w-full flex flex-row justify-between items-center border-cyan-300 border-t-2 border-b-2 p-4 cursor-pointer ${
        selectedStock === abbr && "bg-cyan-800"
      } bg-black`}>
      <div className='flex flex-row items-center space-x-4'>
        ...
        <div className='w-28 flex flex-col justify-start'>
          <h3 className='text-lg text-white font-semibold leading-0'>{abbr}</h3>
