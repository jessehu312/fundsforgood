...
const SidePanel = ({ auth, hScreen, index }) => {
  ...
  return (
    <>
      <div
        className={`hidden lg:block lg:flex-shrink-0 bg-black w-48 lg:w-64 ${
          hScreen ? "h-screen" : ""
        }`}>
        <div className='px-4 py-16'>
          <div
            className='flex flex-row justify-start items-center lg:pl-4 cursor-pointer'
            onClick={() => router.push("/")}>
      ...
      <div
        className={`block lg:hidden lg:flex-shrink-0 bg-black w-24 ${
          hScreen && "h-screen"
        }`}>
        <div className='px-4 py-16'>
